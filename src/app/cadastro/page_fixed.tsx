        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-8 transform hover:scale-105 transition-transform duration-300">
              <div className="bg-white rounded-2xl p-6 shadow-2xl ring-4 ring-emerald-100">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 ${
                    focoNome ? 'text-emerald-500' : 'text-gray-400'
                  }`}>
                  ...
                  <input
                    ...
                    autoComplete="name"
                    required
                    className={`block w-full pl-10 pr-3 py-3 border-2 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 bg-white/70 ${
                      focoNome ? 'border-emerald-300 bg-white shadow-lg' : 'border-gray-200 hover:border-gray-300'
                    }`}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 ${
                    focoEmail ? 'text-emerald-500' : 'text-gray-400'
                  }`}>
                  ...
                  <input
                    ...
                    required
                    className={`block w-full pl-10 pr-3 py-3 border-2 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 bg-white/70 ${
                      focoEmail ? 'border-emerald-300 bg-white shadow-lg' : 'border-gray-200 hover:border-gray-300'
                    }`}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 ${
                    focoSenha ? 'text-emerald-500' : 'text-gray-400'
                  }`}>
                  ...
                  <input
                    ...
                    required
                    className={`block w-full pl-10 pr-12 py-3 border-2 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 bg-white/70 ${
                      focoSenha ? 'border-emerald-300 bg-white shadow-lg' : 'border-gray-200 hover:border-gray-300'
                    }`}
