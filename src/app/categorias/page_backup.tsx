        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <HelpButton 
                title="Como criar e gerenciar categorias"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-white font-medium text-gray-900 placeholder-gray-500"
                    required
                  />
                </div>
                  ...
                  {CORES_DISPONIVEIS.map((cor) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-xl border-2 transition-all hover:scale-110 ${
                        formData.cor === cor ? "border-gray-800 scale-110 shadow-lg" : "border-gray-300"
                      }`}
                      style={{ backgroundColor: cor }}
                    />
                  ))}
                </div>
                <div className="mt-4 flex items-center gap-3 p-4 bg-gray-50 rounded-xl border-2 border-gray-200">
                  <div
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-800">Prévia da categoria</p>
                    <p className="text-xs text-gray-600">Cor: {formData.cor}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 gap-2">
                  {ICONES_DISPONIVEIS[formData.tipo].map((icone) => (
                    <button
                      ...
                      className={`w-12 h-12 rounded-xl border-2 transition-all hover:scale-110 flex items-center justify-center text-xl ${
              ...
              <div className="flex gap-4 pt-6">
                <button
                  type="button"
                  onClick={resetForm}
                  className="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-700 py-3 rounded-xl font-medium transition-colors duration-200"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-medium shadow-lg"
                >
